...
const AddOptionModal = function ({
    ...
    const handleSaveClick = () => {
        ...
        if (id) {
            editData(collectionName, label, editerText, id, callBack)
        } else {
            addData(collectionName, label, editerText, userId, callBack)
        }
    }
    return (
        <>
            ...
            >
                <Box sx={style}>
                    ...
                    <Typography sx={{ m: 2 }}>
                        Create a label that will be the text that appears on the
                        button for your slecting your text.
                    </Typography>
                    <TextField
                        sx={{
                            m: 0.5,
